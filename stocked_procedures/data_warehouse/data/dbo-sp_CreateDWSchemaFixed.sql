USE [DWmachines]
GO
/****** Object:  StoredProcedure [dbo].[sp_CreateDWSchema_Fixed]    Script Date: 5/2/2025 11:05:54 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dbo].[sp_CreateDWSchema_Fixed]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        BEGIN
            CREATE TABLE [FactMachineCleaning] (
              ...
              [tabs_status_left] varchar(255),
              [tabs_status_right] varchar(255),
              [detergent_status_left] varchar(255),
              [detergent_status_right] varchar(255),
              [milk_pump_error_left] varchar(10),
              [milk_pump_error_right] varchar(10),
              [milk_clean_temp_left] decimal(10, 2),
              [milk_clean_temp_right] decimal(10, 2),
              [milk_clean_rpm_left] int,
              [milk_clean_rpm_right] int,
              [milk_seq_cycle_left] varchar(255),
              [milk_seq_cycle_right] varchar(255),
